...
ADMINS = [("""Ahmed Elfateh""", "elfateh@socailpost.geo")]
...
SWAGGER_SETTINGS = {
    ...
    "LOGOUT_URL": "http://localhost:8000/admin/logout/?next=/admin/",
...
ABSTRACT_API_KEY_HOLYDAY = env("ABSTRACT_API_KEY_HOLYDAY", default="")
